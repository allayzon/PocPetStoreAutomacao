...
public class UserTests {
	...
	public void testeGetUserPorNome() {
		...
		Response response = UserEndPoints.lerUsuario(userPayload.getUsername());
	...
	public void testeUpdateUserPorNome() {
		...
		Response response = UserEndPoints.atualizarUsuario(this.userPayload.getUsername(), userPayload);
		response.then().log().all(); 
		
		Assert.assertEquals(response.getStatusCode(), 200);
		
		Response responseDepoisDoUpdate = UserEndPoints.lerUsuario(userPayload.getUsername());
	...
	public void testeDeletePorNome() {
		...
		Response response = UserEndPoints.apagarUsuario(this.userPayload.getUsername());
